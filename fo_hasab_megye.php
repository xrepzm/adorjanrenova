...
if ( $conn ){
	...
	$szoveg3 =  csere( $szoveg3, $modul );
			...
			/*$blog_res_kepek=mysql_query("select * from galeria_megye WHERE menu_id=".$id." order by id desc limit 0, 1");
...
<?php
			...
			echo "
				...
				<!--<H4>".$h4."</H4>
				<div class='blog_lista_leiras'>".$szoveg."</div>-->
				<H4>".$h42."</H4>
				<div class='blog_lista_leiras'>".$szoveg2."</div>
				<div class='blog_lista_leiras'>".$szoveg3."</div>
			";
}
?>
</div>
